...
## 🖼️ โปสเตอร์ + Preview ในหน้า Dashboard / รอดู (25 ก.ย. 69) — ✅ deploy แล้ว
...
1. **ยืนยันโปสเตอร์ใน Dashboard** — ให้พี่แอ้รีเฟรช Dashboard แล้วดูว่า 2 เรื่องมีโปสเตอร์ และคลิกแล้วขึ้น Preview (ต้องล็อกอิน Claude ทดสอบเองไม่ได้)
