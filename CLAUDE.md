...
1. **ความเรียบร้อยสำหรับผู้ใช้ 25–65+** (ไม่ต้องแก้ฐานข้อมูล)
   ...
   - แถว "ญี่ปุ่น" (ภาพยนตร์) ในไทยและเอเชียมีหนังผู้ใหญ่ญี่ปุ่นยุคเก่าติดมา (เช่น "Sex Rider: Wet Highway") แม้ส่ง `include_adult=false` — เห็นชัดขึ้นหลังเปลี่ยนเป็นชื่ออังกฤษ · ถามพี่แอ้ว่าจะกรองไหม (เช่น ตั้ง `vote_count.gte` สูงขึ้นสำหรับแถวนี้)
